	...
	<div class="container header">
		<div class="row">
			...
			<div class="col-md-4 arka-c text-center">
				...
				<a href=""><img src="img/verstka/logo.png"></a>
			</div>
			<div class="col-md-4 "></div> 
		</div>
		<div class="row contacts-row">
			<div class="col-md-4 text-center">
				<div class="social">
					...
					<a href="https://www.instagram.com/"><img class="scale" src="img/verstka/insta.png" alt="insta"></a>
				</div>
			...
			<div class="col-md-4 contacts">
				...
				<div >
					<ul class="contacts-inner" style="list-style:none;">
						<li><a href=""><img class="scale" src="img/verstka/phone.png"></a>    Перезвонить</li>
						<li><a href=""><img class="scale" src="img/verstka/skype.png"></a>    Skype-консультация</li>
						<li><a href=""><img class="scale" src="img/verstka/mail.png"></a>     Написать нам</li>
					</ul>
				</div>
